...
Sample $x \in X$ with probability $\propto |S_x|$. \label{algLine:size}\\
Sample $y$ uniformly at random from $S_x$. \label{algLine:sample}\\
\If {$\mc C^*(x, y) = 1$}{\label{algLine:oracleP21}
	Output $(x, y)$.
	}
}
\end{algorithm}
